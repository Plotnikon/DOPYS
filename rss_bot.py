...
ЦІНА ГРИ
Якщо новина явно стосується конкретної гри, яку можна придбати (анонс релізу, вихід гри, велика знижка, відкриття передзамовлень) — ЗАВЖДИ виконай пошук актуальної ціни через інструмент пошуку, навіть якщо ціна вже згадана в тексті статті-джерела. НЕ покладайся на ціну зі статті — вона може бути застарілою або тільки для одного регіону. Шукай у такому порядку пріоритету:
