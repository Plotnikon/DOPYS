...
Якщо один із двох випадків вище підходить І ціна явно вказана в самому тексті статті-джерела — вкажи цю ціну в пості. НЕ шукай ціну через жодні зовнішні джерела чи інструменти — інструменту пошуку в тебе немає, працюй лише з тим, що є в тексті статті. Якщо ціна в статті не вказана — просто не додавай рядок з ціною, це нормально.

Пріоритет валюти, якщо в статті вказано кілька: гривня (UAH) > долар США (USD) > будь-яка інша.
...
3. Якщо є рядок з ціною — він справді доречний (лише нова гра з щойно відомою ціною або новина про знижку) І ціна дійсно була в тексті статті, інакше рядок з ціною відсутній
